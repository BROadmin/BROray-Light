...
BRORAY_XRAY_BINARY="${BRORAY_XRAY_BINARY:-$BRORAY_ROOT/runtime/xray}"
BRORAY_XRAY_CONFIG="${BRORAY_XRAY_CONFIG:-$BRORAY_ROOT/config/config.json}"
BRORAY_XRAY_INIT="${BRORAY_XRAY_INIT:-$BRORAY_ROOT/bin/broray-xray-control}"
BRORAY_XRAY_ASSET_DIR="${BRORAY_XRAY_ASSET_DIR:-$BRORAY_ROOT/bin}"
