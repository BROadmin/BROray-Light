...
3. Выполните проверяемый блок из [пошаговой инструкции](docs/beginner-installation.md#4-чистая-установка-200). Он скачивает точный установщик в RAM и проверяет SHA-256 **d58e07633d79780e4102505f2db16c5e93328cd7956d6654c02a77940527ba82** до запуска.
