...
Опубликован [Stable 2.0.0](https://github.com/BROadmin/BROray-Light/releases/tag/v2.0.0) — 11 сентября 2026 г.. Независимые Build A/B, подпись и приёмка тестового роутера пройдены.
...
- **2.0.0 — 11 сентября 2026 г.:** выбор Xray, защита от несовместимого архива, исправления подписок и процесса, RAM-операции, сохранение canonical-владельца дублей.
