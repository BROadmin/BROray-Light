...
# Light owns exactly one runtime/config pair. A foreign /opt/bin/xray or a
# validator must never determine the status of the managed Light runtime.
broray_xray_binary_path() {
    printf '%s\n' "$BRORAY_ROOT/runtime/xray"
}
